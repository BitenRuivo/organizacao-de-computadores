...
.text
	main:
		# Operação jal realiza jump e armazena o endereço PC em $ra			
		jal PROC_TRANS     # Chamada do procedimento "transposta"
		jal PROC_MUL  # Chamada do procedimento "multiplicacao"
	...
	jr $ra # Retorno ao jal que chamou o procedimento e incremento do PC
